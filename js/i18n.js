...
const I18N = {
  ...
  translations: {
    en: {
      ...
      th_intro: "How we sequence the full coffee chain — high-frequency first, heavy assets last — and why cultivation still comes first.",
      th_oneliner: "Open cultivation small, but point commercial resources at high-frequency entry points: an AI Agent as the hub; zero-carbon shopping, a coffee savings bank, shared roasting and curve IP for frequency; green and roasted bean trade for cash flow; franchising for scale — crowdfunding and REITs for capitalisation, last.",
      th_pr_t: "Four Operating Principles",
      th_p1_t: "Frequency beats margin",
      th_p1_d: "Lock in daily repeat purchase before chasing cultivation profit. Frequency compounds into data, and data into pricing power.",
      th_p2_t: "Asset-light beats asset-heavy",
      th_p2_d: "Trade, platforms, shared roasting and franchising scale without heavy capex; cultivation and REITs are sequenced, never rushed.",
      th_p3_t: "Data beats supply chain",
      th_p3_d: "One AI middle platform owns membership, orders, roast curves and carbon metering — the credit-pricing authority of the chain.",
      th_p4_t: "Cash flow precedes valuation",
      th_p4_d: "Trade, subscriptions and prepaid balances fund the story; valuations follow real, auditable cash flow.",
      th_layers_t: "The Chain in Three Layers",
      th_l1_t: "High-frequency touchpoints",
      th_l1_d: "Coffee Agent · zero-carbon marketplace · savings bank · shared roasting · curve IP · franchising",
      th_l2_t: "Mid-frequency supply chain",
      th_l2_d: "Green and roasted bean trade · processing · central roastery",
      th_l3_t: "Low-frequency heavy assets",
      th_l3_d: "Aeroponic cultivation · tissue culture · coffee REITs — technology barriers, brand story, ESG carbon assets, exit assets",
      th_phase_t: "A 60-Month Build Order",
      th_ph1_n: "Phase 1 · 0-12 months",
      th_ph1_d: "Agent 1.0, zero-carbon marketplace MVP, savings-bank light, one shared-roasting flagship, small-batch trade, 1-2 aeroponic demo pods — story, carbon certification and limited beans, not volume.",
      th_ph2_n: "Phase 2 · 12-36 months",
      th_ph2_d: "Central roastery capacity, 2-3 owned model stores, the franchising playbook, crowdfunding for demand-testing, savings-bank upgrade with custody and traceability.",
      th_ph3_n: "Phase 3 · 36-60 months",
      th_ph3_d: "Scale cultivation pods once premium beans are proven, then package stable assets — stores, roastery, warehousing, growing facilities — into REITs; carbon and data assets feed the valuation.",
      th_fly_t: "The Financial Flywheel",
      th_fly_d: "Agent acquires, the zero-carbon marketplace repurchases, prepaid balances and subscriptions lock users in, trade and roasting supply the chain, franchising scales, crowdfunding pre-sells, mature assets enter REITs, and recycled capital feeds the whole chain. Revenue then comes from member float, supply-chain spread, franchise and SaaS fees, curve-IP royalties, carbon income and securitisation.",
      ...
      th_s5: "Aeroponic / tissue culture",
      th_s5d: "Biological assets, technology option, carbon credits, ESG premium",
      th_s6: "Coffee REITs",
      th_s6d: "FFO, cap rate, occupancy, lease stability",
      th_synergy: "SOTP must exceed the sum of parts: the AI platform cuts acquisition and risk costs, the marketplace feeds orders, the savings bank holds float, trade discovers price, franchising compounds cash flow — and REITs provides the exit.",
      th_myview_t: "Our Position: Four Corrections to the Standard Play",
      th_mv1_t: "1 · Cultivation is not last — its story is first",
      th_mv1_d: "Sequence the cash flow of heavy assets, but front-load their narrative and pricing power. Without controlled cultivation and certified low-carbon beans, the zero-carbon marketplace is just another store and the savings bank is just stored value. Cultivation turns coffee into an auditable carbon asset and traceable scarce supply — the anchor of every premium in this chain.",
      ...
      th_mv4_d: "Twelve business lines are an attention catastrophe for an early team. We hold ourselves to the three-things test: Agent + marketplace + light savings bank; shared roasting + curve IP; trade + cultivation demos. REITs is a consequence, never a goal — and the three-entity structure (operating / supply-chain / asset companies) is set up from day one, because splitting later costs a hundred times more.",
      ...
      th_cap_d: "Seed: Agent 1.0, marketplace MVP, one shared-roasting flagship. A round: trade, model stores, prepaid system. B round: central roastery, franchise rollout, curve-IP platform. Pre-REITs: asset packages with stable leases. REITs: exit and recycle into cultivation and globalisation.",
    ...
    zh: {
      ...
      nav_thesis: "投资论点",
      th_title: "投资论点",
      th_intro: "如何为全产业链排兵布阵——高频先行、重资产殿后——以及为什么种植端依然必须第一天就上场。",
      th_oneliner: "种植/组培先小规模开,但商业资源优先投给高频入口:以 AI Agent 为中枢,用零碳购物+咖啡储蓄银行+共享烘焙+曲线 IP 做高频,用生熟豆贸易做现金流,用加盟做规模——最后用众筹与 REITs 完成资本化。",
      th_pr_t: "四大经营原则",
      th_p1_t: "高频先于高毛利",
      th_p1_d: "先锁定日常复购,再追求种植利润。高频沉淀为数据,数据沉淀为定价权。",
      th_p2_t: "轻资产先于重资产",
      th_p2_d: "贸易、平台、共享烘焙与加盟无需重资本即可扩张;种植与 REITs 只能被排期,不能被催熟。",
      th_p3_t: "数据先于供应链",
      th_p3_d: "一个 AI 中台统一会员、订单、烘焙曲线与碳计量——这就是整条链的信用定价权。",
      th_p4_t: "现金流先于估值",
      th_p4_d: "贸易、订阅与储值养活故事;估值只跟随真实、可审计的现金流。",
      th_layers_t: "三层链条结构",
      th_l1_t: "高频触点层",
      th_l1_d: "咖啡 Agent · 零碳购物平台 · 储蓄银行 · 共享烘焙 · 曲线 IP · 加盟",
      th_l2_t: "中频供应链层",
      th_l2_d: "生熟豆贸易 · 加工 · 中央烘焙工厂",
      th_l3_t: "低频重资产层",
      th_l3_d: "雾化水培种植 · 组培技术 · 咖啡 REITs——技术壁垒、品牌故事、ESG 碳资产、退出资产",
      th_phase_t: "60 个月建设时序",
      th_ph1_n: "第一阶段 · 0-12 个月",
      th_ph1_d: "Agent 1.0、零碳商城 MVP、储蓄银行轻版、一家共享烘焙旗舰店、小批量贸易、1-2 个雾培示范舱——做故事、碳认证与限量豆,不做量产。",
      th_ph2_n: "第二阶段 · 12-36 个月",
      th_ph2_d: "中央烘焙产能、2-3 家直营样板店、加盟手册、众筹做需求测试、储蓄银行升级仓单溯源与代储。",
      th_ph3_n: "第三阶段 · 36-60 个月",
      th_ph3_d: "特色豆被市场验证后复制雾培舱,再把稳定资产——门店、烘焙厂、仓储、种植设施——打包进 REITs;碳资产与数据资产反哺估值。",
      th_fly_t: "金融飞轮",
      th_fly_d: "Agent 获客 → 零碳商城复购 → 储值/订阅锁客 → 贸易与烘焙供给 → 加盟扩张 → 众筹预售 → 成熟资产进 REITs → 回笼资金反哺全链。收入结构随之变为:会员浮存金、供应链利差、加盟与 SaaS 费、曲线 IP 分成、碳收益与资产证券化。",
      th_sotp_t: "分层估值(SOTP)",
      ...
      th_s5: "雾培/组培",
      th_s5d: "生物资产、技术期权、碳信用、ESG 溢价",
      th_s6: "咖啡 REITs",
      th_s6d: "FFO、Cap rate、出租率、租约稳定性",
      th_synergy: "SOTP 应高于板块简单相加:AI 平台降低获客与风控成本,商城输送订单,储蓄银行沉淀浮存金,贸易发现价格,加盟复利现金流——REITs 提供退出。",
      th_myview_t: "我们的立场:对标准打法的四个修正",
      th_mv1_t: "一 · 种植端不是最后——它的叙事必须最前",
      th_mv1_d: "重资产的现金流可以后置,但其叙事与定价权必须前置。没有可控种植与低碳认证豆,零碳商城只是又一家电商,储蓄银行只是储值。种植端把咖啡变成可审计的碳资产与可溯源的稀缺供给——这是全链路每一个溢价的锚。",
      ...
      th_mv4_t: "四 · 纪律胜过蓝图",
      th_mv4_d: "十二条业务线对早期团队是注意力灾难。我们以三件事为纪律:Agent+商城+储蓄银行轻版;共享烘焙+曲线 IP;贸易+种植示范。REITs 是结果,永远不是目标——而运营/供应链/资产三主体拆分必须从第一天完成,因为日后重组的成本高出百倍。",
      ...
      th_cap_t: "资本路径",
      th_cap_d: "种子轮:Agent 1.0、商城 MVP、一家共享烘焙旗舰店。A 轮:贸易、样板店、储值体系。B 轮:中央烘焙厂、加盟复制、曲线 IP 平台。Pre-REITs:稳定租约的资产包。REITs:退出并反哺种植与全球化。",
    ...
    ar: {
      ...
      th_phase_t: "خطة بناء لـ 60 شهراً",
      th_fly_t: "عجلة القيمة المالية",
